...
import com.uvk.readwrite.DatabaseItemReader;
import com.uvk.test.SpringBatchDatabaseToCSVApplication;

@Configuration
@EnableBatchProcessing
@ImportResource("classpath:/jobs/job-extract-items.xml")
//@ImportResource(SpringBatchDatabaseToCSVApplication.class)
...
public class BatchConfiguration {
 ...
 public DataSource dataSource() {
  ...
  //dataSource.setUrl("jdbc:sqlserver://localhost:3306/shubhaDB");
